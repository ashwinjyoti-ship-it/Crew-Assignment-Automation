...
-- Senior Crew
INSERT INTO crew (name, level, can_stage, stage_only_if_urgent, venue_capabilities, vertical_capabilities, special_notes) VALUES
('Naren', 'Senior', 1, 1, 
...
-- Outside/Hired Crew
INSERT INTO crew (name, level, can_stage, stage_only_if_urgent, venue_capabilities, vertical_capabilities, special_notes) VALUES
('Outside Crew 1', 'Hired', 1, 0,
 '{"JBT": "N", "Tata": "N", "Experimental": "N", "Little Theatre": "N", "Godrej Dance": "N", "Others": "N"}',
 '{"Indian Music": "Y", "Intl Music": "Y", "Western Music": "Y", "Theatre": "Y", "Corporate": "Y", "Library": "Y", "Dance": "Y", "Others": "Y"}',
 'Stage only. Use when internal unavailable');

INSERT INTO crew (name, level, can_stage, stage_only_if_urgent, venue_capabilities, vertical_capabilities, special_notes) VALUES
('Outside Crew 2', 'Hired', 1, 0,
 '{"JBT": "N", "Tata": "N", "Experimental": "N", "Little Theatre": "N", "Godrej Dance": "N", "Others": "N"}',
 '{"Indian Music": "Y", "Intl Music": "Y", "Western Music": "Y", "Theatre": "Y", "Corporate": "Y", "Library": "Y", "Dance": "Y", "Others": "Y"}',
 'Stage only. Use when internal unavailable');
